RSpec.describe 'all pattern' do
  ...
  it 'test 3' do
    ...
    words.each do |word|
      all_four_letters = false unless word.length >=4 && word.length <=4
    end
  ...
  it 'test 7' do
    ...
    zip_codes.each do |v|
      all_five_digits = false unless v.to_s.length >=5 && v.to_s.length <=5 
    end
  ...
  it 'test 9' do
    ...
    all_caps = true 
    snacks.each do |v| 
      all_caps = false unless v.upcase!
    end 
